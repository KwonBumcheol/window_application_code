...
int main(){
    ...
    // Image* img1 = new Image("https://a.com/image/a.png");
    Image* img1 = factory.CreateImage("https://a.com/image/a.png");
    img1->Draw();

    // Image* img2 = new Image("https://a.com/image/a.png");
    Image* img2 = factory.CreateImage("https://a.com/image/a.png");
    img2->Draw();
}